...
import { useCSVImport, useBulkAnalyzeLeads } from '@/lib/hooks'
...
interface ImportResult {
  ...
  lead_ids?: string[]   // returned by the API so we can auto-score
}
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (res.imported > 0) {
        ...
        // Auto-score all imported leads if the API returned their IDs
